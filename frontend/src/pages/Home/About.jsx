      ...
      <div className="container-custom max-w-4xl text-center">
        ...
        <div className="mt-10 space-y-6 text-gray-700 leading-relaxed text-left">
          ...
          <p>
            ...
            Our goal is to simplify daily meal planning by offering flexible
            subscriptions and consistent quality.
          </p>

          <p>
            We understand the challenges of maintaining a healthy diet in a
            busy lifestyle. That’s why we focus on delivering freshly cooked,
            hygienic, and balanced meals directly to your doorstep.
          </p>

          <p>
            Whether you're a student, working professional, or vendor,
            TiffinWala provides a seamless experience for managing meals,
            subscriptions, and deliveries efficiently.
          </p>
